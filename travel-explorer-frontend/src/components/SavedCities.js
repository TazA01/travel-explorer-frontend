...
const SavedCities = ({ cityName, country, location, image, places, id }) => {
    ...
    let savedCitiesClick = async () => {
        let response = await axios.get("https://travel-explorer.azurewebsites.net/cities/save");
    ...
    const remove = async (id) => {
        ...
        await axios.delete(`https://travel-explorer.azurewebsites.net/cities/delete/${id.id}`).then(() => {
